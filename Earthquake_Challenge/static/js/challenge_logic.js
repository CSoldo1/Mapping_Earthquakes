...
// We create additional tile layer that will be the background of our map.
...
// Add the layer groups for all the data.
...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson").then(function(data) {
  ...
  // Using the same style as the earthquake data create a function 
  // with three colors for the earthquakes based on magnitude.
  // the function will determine the radius of the earthquake marker
  // based on magnitude
...
// ADDING EATHQUAKES >4.5 MAGNITUDE
...
// Create a function that determines the radius of the earthquake marker based on its magnitude.
function getRadius(magnitude) {
  if (magnitude === 0) {
    return 1;
  }
